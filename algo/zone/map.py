...
from zone.obstacle import Obstacle
...
class Map:
    bounds = {
        ...
        Movement.FORWARD_LEFT: FL_X_BOUND + FL_Y_BOUND,
        Movement.FORWARD_RIGHT: FR_X_BOUND + FR_Y_BOUND,
        Movement.BACKWARD_LEFT: BL_X_BOUND + BL_Y_BOUND,
        Movement.BACKWARD_RIGHT: BR_X_BOUND + BR_Y_BOUND
    }
